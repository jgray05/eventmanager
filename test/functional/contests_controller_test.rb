...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { end_date: @contest.end_date, present_to_win: @contest.present_to_win, prize: @contest.prize, start_date: @contest.start_date }
    end
  ...
  test "should update contest" do
    put :update, id: @contest, contest: { end_date: @contest.end_date, present_to_win: @contest.present_to_win, prize: @contest.prize, start_date: @contest.start_date }
    assert_redirected_to contest_path(assigns(:contest))
  end
